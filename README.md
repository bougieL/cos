...
@bougiel/cos/0.0.5 darwin-x64 node-v10.16.0
$ cos --help [COMMAND]
USAGE
  $ cos COMMAND
...
...
_See code: [src/commands/bucket.ts](https://github.com/bougieL/cos/blob/v0.0.5/src/commands/bucket.ts)_
...
_See code: [src/commands/config.ts](https://github.com/bougieL/cos/blob/v0.0.5/src/commands/config.ts)_
...
_See code: [src/commands/object.ts](https://github.com/bougieL/cos/blob/v0.0.5/src/commands/object.ts)_
